...
const handleClose = () =>
    hasChanges.value ? (showCloseConfirmation.value = true) : emit("close");
const handleDelete = () => (showCloseConfirmation.value = true);
const confirmDelete = () => (
    (showDeleteConfirmation.value = false), emit("delete")
);
const confirmClose = () => (
    (showCloseConfirmation.value = false), emit("close")
);
    ...
    >
        <div class="flex flex-col gap-6">
            ...
            <div class="flex gap-4 justify-end">
                ...
                <Button class="bg-green-500 text-white" @click="handleSubmit">
